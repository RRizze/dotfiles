...
theme.font          = "Fira Code Medium 13"
theme.font = "Hack Medium 13"
--theme.font = "Open Sans bold 13"
theme.icon_size = 12
...
theme.taglist_fg_foucs = colors.color3
...
theme.taglist_text_color_occupied  = colors.color4
theme.taglist_text_color_focused  = colors.color10
